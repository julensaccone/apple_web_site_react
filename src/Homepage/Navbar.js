...
const Navbar = () => {
  ...
  return (
    <>
      <nav className={isActive ? "navbar-active" : isSearchActive? "hide": "" }>
        <ul>
      ...
      <SearchField isSearchActive={isSearchActive} toggleSearch={toggleSearch}/>
...
const SearchField = ({isSearchActive, toggleSearch}) =>{
  return (
    <>
    <div className={isSearchActive? "search-container" : "search-container hide"}>
      ...
      <div className="quick-links">
        <h2>Quick links</h2>
        <ul>
          <li><a>Visiting an Apple FAQz</a></li>
          <li><a>AirPods</a></li>
          <li><a>AirTag</a></li>
          <li><a>AppleCare+</a></li>
    ...
    <div onClick={toggleSearch} class={isSearchActive? "overlay show" : "overlay"}></div>
    </>
  )
}
